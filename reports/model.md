...
month has been read 3 time(s) so far; each read and its purpose is
...
| LightGBM | 0.637 | 0.927 | 32.2% / 50.3% / 56.2% / 73.3% | 60.1% | 0.0182 | 0.0019 |
...
- **LightGBM** — all 452 features (history aggregates, readable fields and Vesta's anonymised columns). num_leaves = 255, min_child_samples = 50, scale_pos_weight = 5.0, 3175 trees (early stopping on validation PR-AUC), chosen from 8 settings. Calibration: platt.
...
| LightGBM | 0.02007 | 0.01826 | 0.01832 | platt |
